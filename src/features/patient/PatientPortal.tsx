...
import { fetchPatientAppointments, cancelExistingAppointment } from '../../application/slices/appointmentSlice';
...
export function PatientPortal() {
  ...
  const upcoming = appointments.filter(a => a.status === 'CONFIRMED' || a.status === 'PENDING').sort((a,b) => a.date.localeCompare(b.date));
    ...
    <div className="w-full space-y-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="md:col-span-2 space-y-6">
          ...
          {upcoming.map(appt => (
            <Card key={appt.id} className="overflow-hidden border-blue-100 shadow-sm transition-shadow hover:shadow-md">
