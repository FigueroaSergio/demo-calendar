      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="space-y-6">
          <Card className="shadow-md border-border">
            ...
            <CardContent className="pt-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    readOnly
                    onChange={(e) =>
                      setNumDoctors(Math.max(1, parseInt(e.target.value) || 0))
                    }
                  />
                </div>
              ...
              <div className="separator my-2 border-t border-border" />

              <div className="space-y-3">
                <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
                  {t("scheduling.requiredPerDay")}
                </h4>
              ...
              {isImpossible && (
                <div className="p-3 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900 rounded-lg flex gap-2.5 text-xs text-amber-800 dark:text-amber-300">
              ...
              <Button
                ...
                className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold shadow-sm transition-all hover:scale-[1.01]"
              >
                {loading ? (
        ...
        <div className="lg:col-span-2 space-y-6">
          {!loading && !error && !result && (
            <Card className="flex flex-col items-center justify-center p-12 text-center h-full border-dashed border-border">
          ...
          {loading && (
            <Card className="p-12 flex flex-col items-center justify-center text-center h-full border-border">
            ...
            <div className="space-y-6">
              ...
              {result.status === "SATISFIED" && result.solutions.length > 0 && (
                <Card className="shadow-md overflow-hidden">
                  <CardHeader className="border-b border-border bg-muted/50 py-4 px-6">
                    <CardTitle className="text-base font-bold text-foreground">
                      {t("scheduling.gridTitle")}
                    </CardTitle>
                    <CardDescription>
